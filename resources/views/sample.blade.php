    ...
    <div class="">
        ...
        <div class="flex flex-col mx-auto h-screen items-center w-screen lg:w-96">
            <div class="shadow-lg">
                ...
                <img src="{{ asset('img/Sample-AS-1-01.png') }}" class="w-screen lg:w-96 h-full rounded-t-md" alt="">
            </div>
            <div class="mx-auto">
                <audio controls>
            ...
            <div class="shadow-lg">
                ...
                <img src="{{ asset('img/Sample-AS-2-02.png') }}" class="w-screen lg:w-96 h-full rounded-t-md" alt="">
            </div>
            <!--shadow at background-->
            <!--2nd box-->
            <!--white background-->
            <!--paste body back here-->
            <div class="bg-[#F4F1EA] w-96 text-center shadow-lg w-screen lg:w-96 ">
            ...
            <div class="bg-[#F4F1EA] w-96 text-center shadow-lg w-screen lg:w-96">
                ...
                <a href="https://forms.gle/RhmooooxTRspvSoc7" class="bg-gray-500 hover:bg-gray-400 text-white font-bold py-2 px-4 border-b-4 border-gray-700 hover:border-gray-500 rounded">
                    Click Here!
                </a>
                <div class="pt-6">
            ...
            <div class="bg-[#F4F1EA] w-screen lg:w-96 text-center shadow-lg rounded-b-md ">
                    ...
                    <div id="tabs" class="flex justify-between">
                        ...
                        <div id="myModal1" class="modal">
                            ...
                            <div class="modal-content rounded-md">
                                ...
                                <a target=" _blank" href="https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=NnE1cW4xb2VybzVtajc0bmJzbXVzYW1xOTAgMzMzMGE2OWE0YmY1YzBiZTYyOTNiMWFiNGViNzEwNTY3ZjE1NGFiMGJlNmYxYjJhZGU1ODA5MGY5YWJjOWZlOUBn&tmsrc=3330a69a4bf5c0be6293b1ab4eb710567f154ab0be6f1b2ade58090f9abc9fe9%40group.calendar.google.com"><img class="img-center pb-4" src="https://www.google.com/calendar/images/ext/gc_button1_en.gif"></a>
                        ...
                        <div id="myModal2" class="modal">
                            ...
                            <div class="modal-content rounded-md">
                                ...
                                <div class="pb-4">
                                    <a href="https://goo.gl/maps/iJUELwvNg8Gv8YKD8">
                                ...
                                <p class="pb-4">Waze : </p>
                                <div class="pb-4">
                                    <a href="https://waze.com/ul/hw283cgp0h">
                                        <button class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                                            Click here
                                        </button>
                                    </a>
                        ...
                        <div id="myModal3" class="modal">
                            ...
                            <div class="modal-content rounded-md">
                                ...
                                <div class="flex space-x-4 box">
                                    <div class="py-6">
                                        <p class="pb-2 font-poppins">Salina (Kakak)</p>
                                ...
                                <div class="flex space-x-4 box">
                                    <div class="py-6">
                                        <p class="pb-2 font-poppins">Ahmad (Abang)</p>
                                ...
                                <div class="flex space-x-4 box">
                                    <div class="py-6">
                                        <p class="pb-2 font-poppins">Ali (Adik)</p>
